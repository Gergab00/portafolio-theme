/*!
 * Understrap v0.9.0 (gerardogonzalez.dev)
 * Copyright 2013-2022 Gerardo Gonzalez
...
( function ( global, factory ) {
			...
			class Config {
				...
				_mergeConfigObj( config, element ) {
					const jsonConfig = index.isElement( element )
						? Manipulator__default.default.getDataAttribute(
								element,
								'config'
						  )
						: {}; // try to parse
	...
	( function ( module, exports ) {
		( function ( global, factory ) {
			...
			const Config__default =
				/*#__PURE__*/ _interopDefaultLegacy( Config );
			...
			const enableDismissTrigger = ( component, method = 'hide' ) => {
				...
				EventHandler__default.default.on(
					...
					function ( event ) {
						...
						const target =
							index.getElementFromSelector( this ) ||
							this.closest( `.${ name }` );
						const instance =
			...
			const SelectorEngine = {
				...
				focusableChildren( element ) {
					...
					return this.find( focusables, element ).filter(
						( el ) =>
							! index.isDisabled( el ) && index.isVisible( el )
					);
				},
			};
	...
	( function ( module, exports ) {
		( function ( global, factory ) {
			...
			function (
				...
				const Swipe__default =
					/*#__PURE__*/ _interopDefaultLegacy( Swipe );
				const BaseComponent__default =
					/*#__PURE__*/ _interopDefaultLegacy( BaseComponent );
				...
				class Carousel extends BaseComponent__default.default {
					...
					_addEventListeners() {
						...
						if (
							this._config.touch &&
							Swipe__default.default.isSupported()
						) {
	...
	( function ( module, exports ) {
		( function ( global, factory ) {
			...
			commonjsGlobal,
			function ( index, EventHandler, SelectorEngine, BaseComponent ) {
				const _interopDefaultLegacy = ( e ) =>
					e && typeof e === 'object' && 'default' in e
						? e
						: { default: e };
				...
				class Collapse extends BaseComponent__default.default {
					constructor( element, config ) {
						...
						for ( const elem of toggleList ) {
							const selector =
								index.getSelectorFromElement( elem );
							const filterElement =
					...
					hide() {
						...
						for ( const trigger of this._triggerArray ) {
							const element =
								index.getElementFromSelector( trigger );
					...
					_initializeChildren() {
						...
						for ( const element of children ) {
							const selected =
								index.getElementFromSelector( element );
	...
	*/
		...
		( function ( global, factory ) {
			...
			function (
				...
				const Popper__namespace =
					/*#__PURE__*/ _interopNamespace( Popper );
				const EventHandler__default =
					/*#__PURE__*/ _interopDefaultLegacy( EventHandler );
				const Manipulator__default =
					/*#__PURE__*/ _interopDefaultLegacy( Manipulator );
				...
				const PLACEMENT_TOPEND = index.isRTL()
					? 'top-start'
					: 'top-end';
				const PLACEMENT_BOTTOM = index.isRTL()
					? 'bottom-end'
					: 'bottom-start';
				const PLACEMENT_BOTTOMEND = index.isRTL()
					? 'bottom-start'
					: 'bottom-end';
				const PLACEMENT_RIGHT = index.isRTL()
					? 'left-start'
					: 'right-start';
				const PLACEMENT_LEFT = index.isRTL()
					? 'right-start'
					: 'left-start';
				...
				class Dropdown extends BaseComponent__default.default {
					...
					show() {
						if (
							index.isDisabled( this._element ) ||
							this._isShown()
						) {
							return;
						}
					...
					_createPopper() {
						...
						if ( this._config.reference === 'parent' ) {
							...
							index.isElement( this._config.reference )
						) {
							referenceElement = index.getElement(
					...
					_detectNavbar() {
						return (
							this._element.closest( SELECTOR_NAVBAR ) !== null
						);
					}
		...
		( function ( global, factory ) {
			...
			class FocusTrap extends Config__default.default {
				...
				_handleFocusin( event ) {
					...
					const elements =
						SelectorEngine__default.default.focusableChildren(
							trapElement
						);
	...
	( function ( module, exports ) {
		( function ( global, factory ) {
			...
			function (
				...
				const BaseComponent__default =
					/*#__PURE__*/ _interopDefaultLegacy( BaseComponent );
				const Backdrop__default =
					/*#__PURE__*/ _interopDefaultLegacy( Backdrop );
				const FocusTrap__default =
					/*#__PURE__*/ _interopDefaultLegacy( FocusTrap );
				...
				class Modal extends BaseComponent__default.default {
					constructor( element, config ) {
						...
						this._isTransitioning = false;
						this._scrollBar =
							new ScrollBarHelper__default.default();
	...
	( function ( module, exports ) {
		( function ( global, factory ) {
			...
			commonjsGlobal,
			function ( sanitizer, index, SelectorEngine, Config ) {
				const _interopDefaultLegacy = ( e ) =>
					e && typeof e === 'object' && 'default' in e
						? e
						: { default: e };
			...
			function (
				...
				class Tooltip extends BaseComponent__default.default {
					...
					show() {
						...
						const shadowRoot = index.findShadowRoot(
							this._element
						);
					...
					_createTipElement( content ) {
						const tip =
							this._getTemplateFactory( content ).toHtml(); // todo: remove this check on v6
					...
					_getTemplateFactory( content ) {
						if ( this._templateFactory ) {
							...
							this._templateFactory =
								new TemplateFactory__default.default( {
									...this._config,
					...
					_isAnimated() {
						return (
							...
							( this.tip &&
								this.tip.classList.contains( CLASS_NAME_FADE ) )
						);
					}
					...
					_isShown() {
						return (
							this.tip &&
							this.tip.classList.contains( CLASS_NAME_SHOW )
						);
					}
	...
	( function ( module, exports ) {
		( function ( global, factory ) {
			...
			const Tooltip__default =
				/*#__PURE__*/ _interopDefaultLegacy( Tooltip );
			...
			function ( index, EventHandler, SelectorEngine, BaseComponent ) {
				...
				class ScrollSpy extends BaseComponent__default.default {
					...
					_configAfterMerge( config ) {
						...
						config.target =
							index.getElement( config.target ) || document.body; // TODO: v6 Only for backwards compatibility reasons. Use rootMargin only
				...
				EventHandler__default.default.on(
					...
					EVENT_LOAD_DATA_API,
					() => {
						for ( const spy of SelectorEngine__default.default.find(
							SELECTOR_DATA_SPY
						) ) {
			...
			function ( index, EventHandler, SelectorEngine, BaseComponent ) {
				...
				class Tab extends BaseComponent__default.default {
					...
					_keydown( event ) {
						...
						const nextActiveElement = index.getNextActiveElement(
							this._getChildren().filter(
								( element ) => ! index.isDisabled( element )
							),
							event.target,
							isNext,
							true
					...
					_toggleDropDown( element, open ) {
						...
						if (
							! outerElem.classList.contains( CLASS_DROPDOWN )
						) {
							return;
						}
