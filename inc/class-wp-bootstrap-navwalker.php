    ...
    class Understrap_WP_Bootstrap_Navwalker extends Walker_Nav_Menu
    {
        ...
        public function start_el(&$output, $item, $depth = 0, $args = array(), $id = 0)
        {
            ...
            if(!in_array($args->theme_location, array('about', 'resources')))
            {
                ...
                $classes[] = 'list-group-item bg-light';
            }
            ...
            if (isset($args->has_children) && $args->has_children && 0 === $depth && 1 !== $args->depth) {
                ...
                $atts['class'] = 'dropdown-toggle nav-link fs-34 text-white underline-light pb-0 mb-2';
                ...
                if ($depth > 0) {
                    ...
                    $atts['class'] = 'fs-20 text-white text-decoration-none';
                } else {
                    $atts['class'] = 'nav-link fs-34 text-white underline-light pb-0 mb-2';
                }
            }
            ...
            if ('' !== $linkmod_type) {
                ...
                $item_output .= '<a' . $attributes . '><span class="text-white"> # </span>';
            } else {
            ...
            if ('' !== $linkmod_type) {
                ...
                // With no link mod type set this must be a standard <a> tag.
                $item_output .= '<span class="text-white"> /> </span></a>';
            }
