...
// Get our default values
    ...
    public function __construct()
    {
        ...
        add_action('customize_register', array($this, 'understrap_theme_customize_register'));

    }

	public function understrap_theme_customize_register($wp_customize )
	{
    ...
    public function childtheme_add_customizer_sections($wp_customize)
    {
		...
		$wp_customize->add_section('general_section',
			array(
				'title' => __('General section', 'skyrocket'),
				'description' => esc_html__('Here you can configure some things for your theme', 'skyrocket'),
				'panel' => 'child_theme_settings_panels',
			)
		);
    ...
    public function childtheme_register_custom_controls($wp_customize)
    {
        ...
        $wp_customize->add_setting('_container',
            array(
				'default' => 'container',
                'transport' => 'refresh',
                'type' => 'option',
        ...
        $wp_customize->add_control(new Skyrocket_Dropdown_Select2_Custom_Control($wp_customize, '_container',
            array(
                'label' => __('Container selection', 'understrap'),
                'description' => esc_html__('Select the type or types of container that you want to use', 'understrap'),
